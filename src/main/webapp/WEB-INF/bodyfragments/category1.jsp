...
<link rel="stylesheet" href="resources/css/category1.css">
<script src="resources/js/ajax/ajax_category1.js"></script>
...
<%--                    </a>--%>
                ...
                <div class="title-bar">
                    ...
                    <span class="description-category">Khu vực thảo luận về thông tin và các sự kiện về công
                            nghệ</span>
                </div>
                <!-- END_TITLE_BAR -->

                <div class="node-category">
<%--                    <ul class="list-category-lv2">--%>
<%--                        <li class="category-lv2">--%>
<%--                            <div class="category-lv2-right">--%>
<%--                                <i class="fas fa-comments fa-2x"></i>--%>
<%--                                <div class="text-category-lv2">--%>
<%--                                    <h3>--%>
<%--                                        <a href="category2"--%>
<%--                                           title="Tin tức, sự kiện khắp nơi về thế giới công nghệ. Bấm vào đây để xem các bài viết mới nhất.">--%>
<%--                                            Thông tin công nghệ--%>
<%--                                        </a>--%>
<%--                                    </h3>--%>
...
<%--                                <div class="text-category-lv2">--%>
<%--                                    <h3>--%>
<%--                                        <a href="" title="thông tin về công nghệ">--%>
<%--                                            Thương mại điện tử--%>
<%--                                        </a>--%>
<%--                                    </h3>--%>
<%--                                    <span class="tag-category-lv2">Tag: <strong>39,154</strong></span>--%>
